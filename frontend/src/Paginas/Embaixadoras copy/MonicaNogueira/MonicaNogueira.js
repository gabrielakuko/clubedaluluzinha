...
const MonicaNogueira = props => {

  const arrayEmbaixadoras = ([
    { "id": 4, "imagem": Jani, "nome": "Monica Nogueira", "cidade": "Blumenau - SC", "possuiEvento": true }
  ]);
  ...
  return (
	<div className="MonicaNogueira Embaixadora">
    {popupAberto}
    <Menu />
